...
class TESTDataset(JointsDataset):
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        super().__init__(cfg, root, image_set, is_train, transform)

        self.num_joints = 21
        self.flip_pairs = []
        self.parent_ids = [0, 0, 1, 2, 3, 0, 5, 6, 7, 5, 9, 10, 11, 9, 13, 14, 15, 13, 17, 18, 19]

        self.upper_body_ids = (3, 4, 7, 8, 11, 12, 15, 16, 19, 20)
        self.lower_body_ids = (0, 1, 2, 5, 6, 9, 10, 13, 14, 17, 18)
