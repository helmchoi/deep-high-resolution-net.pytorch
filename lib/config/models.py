...
POSE_HIGH_RESOLUTION_NET.UVD = CN()
POSE_HIGH_RESOLUTION_NET.UVD.PRETRAINING = False
POSE_HIGH_RESOLUTION_NET.UVD.NUM_FEATURES = [432]
POSE_HIGH_RESOLUTION_NET.UVD.PRIOR_WEIGHT = 0.0001
